                        ...
                        <div className="panel-body">
                          <p> <b style={{fontWeight:"700", fontSize: '15px'}}>Academics:</b>                        
                            <div className="row" style={{paddingRight: "40px"}}>
                                ...
                                <li> Relevant coursework: Artificial Intelligence (CPSC 570), Systems Programming and Computer Organization (CPSC 323), Data Structures and Programming Techniques (CPSC 223), Vector Calculus and Linear Algebra (MATH 230/231)</li>
